...
public class TechAdapter2 extends FragmentPagerAdapter {
    ...
    private static final int NUM_OF_SUB_EVENTS = 16;
    ...
    public Fragment getItem(int position) {
        switch (position) {
            ...
            case 12 : return SETUFragment.getInstance();
            case 13 : return OneBHKFragment.getInstance();
            case 14 : return PosterPresentationFragment.getInstance();
            case 15 : return DraftItOutFragment.getInstance();
        }
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            ...
            case 12 : return "SETU";
            case 13 : return "1 BHK House";
            case 14 : return "Poster Presentation";
            case 15 : return "Draft It Out";
